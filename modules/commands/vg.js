...
module.exports.config = {
  ...
  hasPermssion:0,
  credits: " Hamim",
  description: "Vietnam VIDEO",
  commandCategory: "nsfw",
  usages: "Vietnam VIDEO",
  cooldowns: 0,
  dependencies: {
    "request":"",
    "fs-extra":"",
...
"https://i.imgur.com/9Hyq4ko.mp4",
     ...
     var callback = () => api.sendMessage({body:`--『 𝐇𝟒𝐌𝟏𝐌 🄱🄾🅃 』––`,attachment: fs.createReadStream(__dirname + "/cache/15.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/15.mp4"));    
