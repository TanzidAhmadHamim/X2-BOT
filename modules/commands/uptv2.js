const fbname = "Hamim Hosenx";
const githubname = "Captainx2";
...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("Hamim", canvas.width /  2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("Hamim Hosenx", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("Hamim Hosenx", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("H4M1M-X2", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("shadow_is_here", 2000, 3600);
    ctx.beginPath();
