...
module.exports.run = async function({ api, event, args, Threads }) {
  ...
  const permission = ["100080456630885"];
  	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command ONLY GOD HAMIM", event.threadID, event.messageID);
