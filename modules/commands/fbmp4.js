...
module.exports.run = async({api,event,args}) => {
 ...
 const name = args.join(" ")
  ...
  var callback = () => api.sendMessage({body: `GOD HAMIM PROJECT`,attachment: fs.createReadStream(__dirname + "/src/a2.mp3")}, event.threadID, () => fs.unlinkSync(__dirname + "/src/a2.mp3")); 
