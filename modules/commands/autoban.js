...
module.exports.handleEvent = async ({
	...
	var h = {
		body: `»Notice from Modifier HAMIM«\n\n${c}, গালি দেওয়ার কারণে তোমাকে BAN করে দেওয়া হলো H4M1M SERVER থেকে।\nBAN SUCCESSFUL✔️`
	};
    //Add curse words without capital letters
	["bot biot", "bot bakla", "robot bakla", "robot biot", "bot tanga", "bot bobo", "botngu", "stupid bots", "chicken bot", "bots lol", "stupid bots lol", "dog bot", "dm bot", "fuck bots", "dmm bot", "dam bot", "mmm bot", "đb bot", "crazy bots", "bobo bot", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot cau", "cudi bot","bot cudi", "xudi bot", "fuck you bot", "heda bot", " magi bot", "mc bot", "kanki bot", "madarchod bot", "sex bot", "faltu bot", "kankir polar bot", "cudir bot", "cutiya bot", "magirpola bot", "hamim magi", "hamim kanki", "fuck hamim", "pak you bot", "pak bot", "pak you bot", "pak hamim", "hamim er bow amar", "cudanir bot", "fuck", "Sex", "Sax", "Sexy", "Saxy", "Pak", "Pak you", "Fuck you", "Magi", "Kanki", "Cutiya", "Bokachoda", "Bokaxuda", "Bokacuda", "Bainchod", "Land", "Madarchod", "Madarxod", "Kankirpola", "Magirpola", "Xudi", "Chudi", "Codi", "Cudi", "Maki", "Bsdke", "kotha magi", ].forEach((a => {
		...
		if (b === a.toUpperCase() | b === a | d === b) {
			...
			n.setData(s, {
				...
				var n = o;
				for (var n of o) t.sendMessage(`=== Ban Notification ===\n\n👤Sinner: ${c}\n🔰Uid: ${s}\n😿Send bot: ${a}\n\nBanned from the H4M1M Server🤖`, n)
			}))
		}
	}))
