module.exports.config = {
 ...
 description: "some logo edit like japan",
...
module.exports.run = async ({ event, api, args }) => {
    ...
    if (this.config.credits != 'Hamim') return;
    ...
    if(!args[0]) return api.sendMessage('USE LIKE THIS\n[0 -> 3] | [ 1 -> 3 ] | [Text] | [Text 2]', threadID, messageID);
   ...
   return api.sendMessage({body:'GOD HAMIM PROJECT',
