...
"https://i.pixxxels.cc/jdM96PZ7/zZKvVvB.jpg",
    ...
    var callback = () => api.sendMessage({ body: `FOR BOYS 🤭\n\nHAMIM API`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
